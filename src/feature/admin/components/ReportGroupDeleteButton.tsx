...
export default function ReportGroupDeleteButton({ reportGroupId }: { reportGroupId: number }) {
    ...
    return (
        <button onClick={handleDelete} className="flex items-center gap-1 sm:gap-1.5 lg:gap-2.5 text-[10px] sm:text-xs lg:text-sm font-medium text-white bg-[#1E2939] border-[#364153] border rounded-lg py-1.5 sm:py-2 px-2 lg:px-3 transition-colors hover:border-white/30 hover:bg-white/10 hover:text-white">
