...
export default function CheckViewModal({ isModal, closeModal, mode, nickname, content }: ChangeStateModalProps) {
    ...
    return (
        <section
            ...
            onClick={closeModal} >
            <form
                className="bg-gradient-to-br from-[#101828] to-[#000] w-5/6 sm:w-md  rounded-2xl border border-[#1E2939] z-1000 fixed top-1/2 left-1/2 p-6 flex -translate-x-1/2 -translate-y-1/2 flex-col justify-between"
                ...
                <article>
                    ...
                    <div className="flex justify-between items-center my-4">
                        <h3 className="font-bold text-base md:text-lg lg:text-xl text-[#E8EAF0] py-2">{nickname}</h3>
                    </div>
                    <div
