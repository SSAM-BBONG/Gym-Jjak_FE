export default function UrlCt({ text, url }: { text: '블로그' | '웹사이트' | '인스타그램', url: string }) {
    return (
        <div
            className="h-14 flex flex-col justify-center border-[#364153] border w-full p-3 md:p-4 mt-2 bg-[#1E2939] rounded-md text-[#D1D5DC] text-sm md:text-base font-normal"
        >
