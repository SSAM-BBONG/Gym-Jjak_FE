...
interface TrainerRegistSelfIntroductionProps {
  register: UseFormRegister<TrainerRegistFormValue>;
  error?: string;
}
export default function TrainerRegistSelfIntroduction({
  register,
  error,
}: TrainerRegistSelfIntroductionProps) {
    return (
        <div className="
            flex flex-col gap-4
            p-8
