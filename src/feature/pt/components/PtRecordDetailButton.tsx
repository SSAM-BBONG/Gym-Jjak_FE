...
export default function PtRecordDetailButton({
    ...
    return (
        <div className="grid grid-cols-4 gap-4">
                <button
                    type="button"
                    className={`py-3 rounded-[10px] text-[16px] font-extrabold hover:cursor-pointer ${
                        isCompleted
                ...
                <button
                    ...
                    className="py-3 rounded-[10px] bg-[#1E2939] text-[16px] font-extrabold text-white hover:cursor-pointer hover:bg-[#BFFF0B] hover:text-black disabled:cursor-not-allowed disabled:opacity-50"
                >
