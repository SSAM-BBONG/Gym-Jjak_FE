...
export default function PtRecordDetailButton() {
    ...
    return (
        <div className="grid grid-cols-4 gap-4">
                <button 
                    className="py-3 rounded-[10px] bg-[#BFFF0B] text-[16px] font-extrabold text-black hover:cursor-pointer"
                ...
                <button className="py-3 rounded-[10px] bg-[#1E2939] text-[16px] font-extrabold text-white hover:cursor-pointer"> 취소 </button>
        </div>
    );
}