      ...
      <div className="flex justify-between">
        <div className="flex flex-col gap-4">
          <div className="flex gap-3 items-center">
            <div className="flex items-center justify-center size-10 bg-[#BFFF0B] rounded-[10px]"> 
                <img src={Logo} alt="하단바 로고"/>
            </div>
          ...
          <div className="flex flex-col gap-3">
            <div className="flex gap-2 items-center">
                <img src={FooterEmail} alt="하단바 이메일 로고"/>
                <p className="text-[#99A1AF]"> ssambbong@eulji.com </p>
            </div>
            <div className="flex gap-2 items-center"> 
                <img src={FooterNumber} alt="하단바 전화번호 로고"/>
