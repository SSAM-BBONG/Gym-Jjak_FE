...
export default function DashboardAdminDropDown() {
    ...
    return (
        <section className="my-2">
            ...
            <ul hidden={dropDownView} className="px-4">
                <li><AdminNavLink href="/admin/dashboard/users">회원 현황</AdminNavLink></li>
                <li><AdminNavLink href="/admin/dashboard/money">매출 현황</AdminNavLink></li>
                <li><AdminNavLink href="/admin/dashboard/contents">콘텐츠 현황</AdminNavLink></li>
            </ul>
        </section>
    );
}