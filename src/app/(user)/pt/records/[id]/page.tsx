        ...
        <div className="flex flex-col gap-5 px-70 py-10">
            ...
            ">
                ...
                <div className="flex flex-col gap-2 flex-7 p-6">
                    <p className="text-[24px] font-black text-white"> {response.data.title}</p>
                    <p className="text-[14px] font-normal text-[#99A1AF]"> {response.data.trainerName}</p>
                    <div className="grid grid-cols-2 gap-4 mt-2">
                        ...
                        <div className="flex flex-col gap-1 p-3 rounded-[10px] bg-[#1E293980]">
                            ...
                            <p className="text-[14px] font-extrabold text-white"> {response.data.status} </p>
                        </div>
                    </div>
