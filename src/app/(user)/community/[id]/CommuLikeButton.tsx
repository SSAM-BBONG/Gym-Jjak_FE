...
export default function CommuLikeButton({ like, likeCount, postId }: { like: boolean, likeCount: number, postId: number }) {
    ...
    return (
        <div className=" flex gap-2 items-center self-center px-3 md:px-4 py-2 bg-[#1E2939] rounded-[10px] font-extrabold text-[10px] md:text-[14px] text-white transition-colors hover:bg-[#1E293999] hover:text-white">
