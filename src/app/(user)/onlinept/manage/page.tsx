import OnlinePtManageCard from "@/feature/onlinept/components/OnlinePtManageCard";

export default function Page() {
    return (
        <div className="flex flex-col gap-1 px-60 py-10">
            <p className="text-[36px] font-black text-white">온라인 PT 관리 </p>
            <p className="text-[14px] font-normal text-[#99A1AF]"> 내 온라인 PT 및 수강생을 관리하세요 </p>
