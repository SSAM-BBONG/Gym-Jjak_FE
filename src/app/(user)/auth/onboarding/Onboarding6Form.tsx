        ...
        <form onSubmit={handleSubmit(handleNext)}>
            <div className="flex flex-col gap-3 pb-8 sm:pb-10 lg:pb-12 w-full sm:w-md lg:w-md m-auto">
                ...
                <div className="flex mb-4 sm:mb-5 lg:mb-6 gap-2"
                    ...
                    <div className="flex items-center text-center font-semibold px-3 sm:px-4 lg:px-6 py rounded-[10px] text-sm sm:text-base lg:text-base bg-[#BFFF0B] text-black">주소 찾기</div>
                </div>
            </div>
