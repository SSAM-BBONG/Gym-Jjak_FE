    ...
    return (
        <div
            ...
            <div className="flex justify-center gap-6 border-t border-[#99A1AF] w-full p-6">
                <a href={`/oauth2/authorization/naver`} className="relative w-15 h-15 rounded-full">
                    <Image
                        src={NaverLogo}
                        alt="네이버로 계속하기"
                        fill
                ...
                <a href={`/oauth2/authorization/google`} className="relative w-15 h-15 rounded-full">
                    <Image
                        src={GoogleLogo}
                        alt="구글로 계속하기"
                        fill
